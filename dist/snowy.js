...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    key: "addFlake",
    value: function addFlake() {
      this.snowList.push(new _snowFlake_js__WEBPACK_IMPORTED_MODULE_0__.SnowFlake(this.stageWidth, this.stageHeight, this.config));
    }
  }, {
    key: "resize",
...
var SnowFlake = /*#__PURE__*/function () {
  function SnowFlake(stageWidth, stageHeight, config) {
  ...
  _createClass(SnowFlake, [{
    ...
    value: function draw(ctx) {
      ...
      switch (this.type) {
        ...
        case "text":
          ctx.font = "".concat(this.radius * 5, "px serif");
          ctx.fillStyle = this.color;
